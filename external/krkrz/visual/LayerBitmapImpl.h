...
public:
	...
	static const tjs_uint32 BMP_MAGIC_VALID = 0xB1FACE00;
	static const tjs_uint32 BMP_MAGIC_DEAD  = 0xDEADFACE;
private:
	tjs_uint32 BmpMagic_;
	tjs_int RefCount;

	void * Bits;
	BitmapInfomation *BitmapInfo;
...
public:
	...
	bool IsBmpValid() const { return BmpMagic_ == BMP_MAGIC_VALID; }
...
{
	static const tjs_uint32 MAGIC_VALID = 0xB17CAFE0;
	static const tjs_uint32 MAGIC_DEAD  = 0xDEADB17;
	tjs_uint32 Magic_;
public:
	bool IsValid() const { return Magic_ == MAGIC_VALID; }
