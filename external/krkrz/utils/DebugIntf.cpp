...
void TVPAddLog(const ttstr &line, bool appendtoimportant)
{
	...
	*p = TJS_W(' ');
	...
	KRKR_LOG_L3("TVPAddLog: before Application->PrintConsole, Application=%p\n", Application);
#if 1
	if(appendtoimportant || TVPLogL2())
	...
	KRKR_LOG_L3("TVPAddLog: after Application->PrintConsole\n");
...
{
	KRKR_LOG_L3("Inside tTJSNC_Debug constructor\n");
...
//----------------------------------------------------------------------
	...
	KRKR_LOG_L3("Before TVPGetVersionInformation\n");
	ttstr ver = TVPGetVersionInformation();
	KRKR_LOG_L3("After TVPGetVersionInformation\n");
	TVPAddImportantLog(ver);
	KRKR_LOG_L3("After TVPAddImportantLog(ver)\n");
	TVPAddImportantLog(ttstr(TVPVersionInformation2));
	KRKR_LOG_L3("After TVPAddImportantLog(ver2)\n");
...
{
	KRKR_LOG_L3("Inside TVPCreateNativeClass_Debug\n");
	tTJSNativeClass *cls = new tTJSNC_Debug();
	KRKR_LOG_L3("Inside TVPCreateNativeClass_Debug after new\n");
	return cls;
}
//---------------------------------------------------------------------------
