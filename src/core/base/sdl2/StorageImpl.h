...
// tTVPHTTPRangeStream
//---------------------------------------------------------------------------
class tTVPHTTPRangeStream : public tTJSBinaryStream
{
private:
	ttstr URL;
...
public:
	tTVPHTTPRangeStream(const ttstr &url);
	~tTVPHTTPRangeStream();
...
enum tTVPXP3ReadClass
{
	TVP_XP3_READ_SMALL_RANDOM = 0,
	TVP_XP3_READ_PSB_FULL = 1,
	TVP_XP3_READ_AUDIO_STREAM = 2,
	TVP_XP3_READ_VIDEO_STREAM = 3
};
